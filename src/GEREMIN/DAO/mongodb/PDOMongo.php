...
class PDOMongo{
	...
	public function update($oldDocument, $newDocument){
		try{
			return $this->collection->update($oldDocument, $newDocument);
		}
		catch(MongoException $e){
			throw new Exception($e);
		}
	...
	public function getLike($attr, $value){
		$regexObj = new MongoRegex("/".$value."/i");
		return $this->get($attr, $regexObj);
	}
